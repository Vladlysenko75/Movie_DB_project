...
export const movieService = {
    ...
    searchMovie: (keyWord, page) => axiosService.get(urls.search.concat(urls.movie, urls.key, urls.query, keyWord, urls.page, page, urls.withoutAdultContent)).then(value => value.data)
}